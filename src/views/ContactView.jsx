...
export default function ContactView() {
    ...
    useEffect(()=> {
        document.querySelector('body').classList.remove('light', 'green')
            ...
            <div className="wrapper dark">
                <main className="contact-view">
                    <section className="hero">
                        ...
                        <h2 className="text-primary">What are we waiting for? <span className="serifed text-accent italic">Get in touch.</span></h2>
                    ...
                    {/* <section className="contacts">
                        <a className="serifed text-primary line-hover-element" href="mailto:hello@peterdaviesdigital.com">hello@peterdaviesdigital.com<span className="hover-line"></span></a>
